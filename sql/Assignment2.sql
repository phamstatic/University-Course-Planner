...
ALTER TABLE atbl_University_Courses ADD CONSTRAINT FK_atbl_University_Courses_Degree FOREIGN KEY (DegreeName) REFERENCES atbl_University_Degrees (DegreeName);
...
INSERT INTO atbl_University_Courses (CourseId, CourseName, DegreeName, CourseCredits, CourseDescription)
VALUES ('MATH2413', 'Calculus I', 'Mathematics', 4, 'Calculus of rational functions, limits, derivatives, applications of the derivative, antiderivatives, the definite integral with applications, mean value theorem, fundamental theorem of calculus, and numerical integration.');

INSERT INTO atbl_University_Courses (CourseId, CourseName, DegreeName, CourseCredits, CourseDescription)
VALUES ('MATH2414', 'Calculus II', 'Mathematics', 4, 'Calculus of transcendental functions: additional techniques and applications of integration, indeterminate forms, improper integrals, Taylor’s formula, and infinite series.');
-------------------------
