...
CASE
	...
	ELSE 1.0
END AS GPA
FROM atbl_University_StudentsDegreesCourses Student
JOIN atbl_University_Courses Course ON Student.CourseId = Course.CourseId
GROUP BY Student.StudentId;

--DROP VIEW aviw_University_StudentsGrades;
--SELECT * FROM aviw_University_StudentsGrades;